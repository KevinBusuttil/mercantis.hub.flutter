...
| C4 | **Field help metadata** | `FieldDefinition.swift` (+46): `helpText`, `placeholder` (ordering: helpText before defaultValue/options) | Missing — `FieldDefinition` has neither field; blocks all form-UX work (C-UI) | High | S |
