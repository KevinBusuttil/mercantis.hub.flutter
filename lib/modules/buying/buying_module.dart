...
abstract final class BuyingModule {
  ...
  static DocType _purchaseOrder() => DocType(
        ...
        namingRule: 'PO-.YYYY.-.####',
        fields: [
          FieldDefinition(key: 'supplier', label: 'Supplier', type: FieldType.link, options: 'Supplier', required: true),
          ...
          FieldDefinition(key: 'items', label: 'Items', type: FieldType.table, options: 'Purchase Order Item'),
  ...
  static DocType _purchaseInvoice() => DocType(
        ...
        fields: [
          ...
          FieldDefinition(key: 'currency', label: 'Currency', type: FieldType.link, options: 'Currency'),
          FieldDefinition(key: 'items', label: 'Items', type: FieldType.table, options: 'Purchase Invoice Item'),
          FieldDefinition(key: 'total', label: 'Total', type: FieldType.currency, readOnly: true),
